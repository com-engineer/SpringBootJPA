...
import com.example.RedisForOrderManagementSystem.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDto>> getActiveCatalog(){
        return ResponseEntity.status(HttpStatus.OK).body(productService.getActiveCatalog());
    }
